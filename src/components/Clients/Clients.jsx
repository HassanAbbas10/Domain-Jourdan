import recSvg from '../../Logos/rec.svg'
import { Fragment } from "react"
import google from '../../Logos/icons8-google.svg'
const Clients = () => {
  return (
    <Fragment>
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    <h2 className="text-center text-2xl font-quicksand  tracking-tight text-gray-900 sm:text-5xl">
  ...
  <div className="flex justify-between">
    <div className="flex gap-4">
      ...
      <div>
        ...
        <p className='text-sm font-light text-slate-400'>6 July 2024</p>
   ...
   <img className='h-8 w-8' src={google} />
  </div>
